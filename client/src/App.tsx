        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              title={showSidebar ? "Ascunde panoul" : "Arată panoul"}
            >
              {showSidebar ? (
                <PanelLeftClose className="size-4 mr-1" />
              ) : (
                <PanelLeftOpen className="size-4 mr-1" />
              )}
              {showSidebar ? "Ascunde" : "Probleme"}
            </Button>
          </div>
                              ...
                              <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                                ...
                                {currentProblem.category && (
                                  <motion.span
                                    initial={{ scale: 0.9 }}
                                    animate={{ scale: 1 }}
                                    className="rounded-full bg-accent/60 px-2 py-0.5"
                                  >
                                    {currentProblem.category}
                                  </motion.span>
                                )}
                      ...
                      <div className="flex items-center gap-3 flex-wrap">
                        ...
                        {(verdict.passedTests != null ||
                          ...
                          >
                            ...
                            {verdict.totalTests ?? 0} teste trecute
                          </motion.span>
                        )}
                      </div>
                    </CardHeader>
                  ...
                  {showTips && (
                    ...
                    >
                      <CardContent className="pt-0 text-sm space-y-2">
                        <p className="text-xs text-muted-foreground">
                          Ai avut {currentAttempts.wrong} încercări greșite
                          pentru această problemă. Fiecare încercare deblochează
                          un nou hint.
                        </p>
                        <motion.div
                          className="space-y-2"
